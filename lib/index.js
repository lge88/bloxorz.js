...
Block.prototype._rollByEdge = function( edgeId ) {
  ...
  if ( edge ) {
    ...
    // from = this.mesh.localToWord( from );
    // to = this.mesh.localToWord( to );
    ...
    // ref.rotation.setFromRotationMatrix( mat );
    ...
    mat.makeRotationAxis( xAxis, Math.PI/2 );
    ref.matrix.multiply( mat );
    ref.matrixWorldNeedsUpdate = true;
    ...
    // this.remove( mesh );
    // detach( mesh, this, scene );
    // attach( mesh, ref, scene );
...
Block.prototype._goDir = function( dir ) {
